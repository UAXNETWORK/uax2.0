...
import (
	...
	"github.com/cosmos/evm/x/bandwidth"
	bandwidthkeeper "github.com/cosmos/evm/x/bandwidth/keeper"
...
func NewExampleApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		evmtypes.StoreKey, feemarkettypes.StoreKey, erc20types.StoreKey, bandwidthtypes.StoreKey,
	)
	...
	*/
	...
	app.BandwidthKeeper = bandwidthkeeper.NewKeeper(
		appCodec,
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		bandwidth.NewAppModule(app.BandwidthKeeper),
	...
	app.ModuleManager.SetOrderEndBlockers(
		...
		evmtypes.ModuleName, erc20types.ModuleName, feemarkettypes.ModuleName, bandwidthtypes.ModuleName,
...
func (app *EVMD) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := evmante.HandlerOptions{
		...
		BandwidthKeeper:        app.BandwidthKeeper,

...
import (
	...
	bandwidthprecompile "github.com/cosmos/evm/precompiles/bandwidth"
...
func (s StaticPrecompiles) WithBandwidthPrecompile(
	...
	bandwidthPrecompile := bandwidthprecompile.NewPrecompile(
		bandwidthkeeper.NewMsgServerImpl(bandwidthKeeper),
		bandwidthKeeper,
		options.AddressCodec,
	)

	s[bandwidthPrecompile.Address()] = bandwidthPrecompile
	return s
}
